...
use std::ops::Range;
use std::ffi::OsStr;
use std::io::{self, Read, Write, Seek, BufReader, BufWriter, SeekFrom};
...
fn new_log_file(dir: &Path, gen: u64, readers: &mut HashMap<u64, BufReaderWithPos<File>>) -> Result<BufWriterWithPos<File>> {
